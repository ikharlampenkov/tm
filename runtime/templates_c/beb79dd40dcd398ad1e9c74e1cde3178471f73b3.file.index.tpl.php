<?php /* Smarty version Smarty-3.0.9, created on 2011-12-01 22:03:27
         compiled from "F:\www\tm\application/views/scripts\task/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:50564ed7973fc77a48-38242327%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '50564ed7973fc77a48-38242327',
  'function' => 
  array (
  ),
...
?><div class="page"><h1><?php if (!isset($_smarty_tpl->getVariable('task',null,true,false)->value)){?>Задачи<?php }else{ ?>Задача: <?php echo $_smarty_tpl->getVariable('task')->value->title;?>
<?php }?></h1></div><br/>
...
<table width="100%">
    ...
    <tr>
        <td class="ttovar" align="center" colspan="5"><a href="<?php echo $_smarty_tpl->getVariable('this')->value->url(array('controller'=>$_smarty_tpl->getVariable('controller')->value,'action'=>'add'));?>
">добавить</a></td>
    </tr>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('if_object_allowed', array('type'=>$_tmp1,'object'=>($_smarty_tpl->tpl_vars['task']->value))); $_block_repeat=true; smarty_block_if_object_allowed(array('type'=>$_tmp1,'object'=>($_smarty_tpl->tpl_vars['task']->value)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
        ...
        <tr>
            <td class="ttovar"><a href="<?php echo $_smarty_tpl->getVariable('this')->value->url(array('controller'=>$_smarty_tpl->getVariable('controller')->value,'action'=>'index','parent'=>$_smarty_tpl->getVariable('task')->value->id));?>
...
" onclick="return confirmDelete('<?php echo $_smarty_tpl->getVariable('task')->value->id;?>
