<?php /* Smarty version Smarty-3.0.9, created on 2011-12-10 15:20:40
         compiled from "F:\www\tm\application/views/scripts\task/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:110464ee31658a4e111-62244603%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '110464ee31658a4e111-62244603',
  'function' => 
  array (
  ),
...
" style="list-style: none;">
                <div style="padding: 5px 0px 5px; 5px; width: 100%; height: 30px; margin: 0px; 5px;" class="<?php if ($_smarty_tpl->getVariable('task')->value->searchAttribute('state')&&$_smarty_tpl->getVariable('task')->value->getAttribute('state')->value=='Выполнена'){?>ttovar_green<?php }elseif($_smarty_tpl->getVariable('task')->value->getIsOver()){?>ttovar_red<?php }else{ ?>ttovar<?php }?>">
                    ...
                    <div style="width: 500px; float:left; margin-left: 5px;">
                        <a href="#" onclick="task.openTask('<?php echo $_smarty_tpl->getVariable('this')->value->url(array('controller'=>$_smarty_tpl->getVariable('controller')->value,'action'=>'showTaskBlock','parent'=>$_smarty_tpl->getVariable('task')->value->id));?>
