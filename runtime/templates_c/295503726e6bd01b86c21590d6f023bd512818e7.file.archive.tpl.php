<?php /* Smarty version Smarty-3.0.9, created on 2011-12-24 15:03:04
         compiled from "F:\www\tm\application/views/scripts\task/archive.tpl" */ ?>
<?php /*%%SmartyHeaderCode:87654ef58738d83582-61008912%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '295503726e6bd01b86c21590d6f023bd512818e7' => 
    array (
      0 => 'F:\\www\\tm\\application/views/scripts\\task/archive.tpl',
      1 => 1324711880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '87654ef58738d83582-61008912',
  'function' => 
  array (
  ),
...
?><div class="page">
    <h1 style="width: 300px;">Проекты. Архив</h1>

    <div class="page_block">
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('if_allowed', array('resource'=>($_smarty_tpl->getVariable('controller')->value)."/index",'priv'=>"show")); $_block_repeat=true; smarty_block_if_allowed(array('resource'=>($_smarty_tpl->getVariable('controller')->value)."/index",'priv'=>"show"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">Проекты</a>
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_if_allowed(array('resource'=>($_smarty_tpl->getVariable('controller')->value)."/index",'priv'=>"show"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
')"><img src="/i/zip.gif" alt="из архива" title="из архива" border="0"/></a>
