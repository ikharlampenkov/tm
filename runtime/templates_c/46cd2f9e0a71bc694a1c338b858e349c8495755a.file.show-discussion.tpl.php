<?php /* Smarty version Smarty-3.0.9, created on 2011-11-30 19:35:46
         compiled from "/home/c/cl71252/tm.cl71252.tmweb.ru/application/views/scripts/task/show-discussion.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12919877234ed630c037e309-68152704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '12919877234ed630c037e309-68152704',
  'function' => 
  array (
  ),
...
?>
        ...
        <li style="list-style: none; padding: 5px; background-color: #f7f7f7;">
            <div style="padding: 5px;">
                <div style="font-size: 12px; line-height: 16px; " id="message_<?php ob_start();?><?php echo $_smarty_tpl->getVariable('discussion')->value->id;?>
<?php $_tmp1=ob_get_clean();?><?php echo $_tmp1;?>
"><?php echo $_smarty_tpl->getVariable('discussion')->value->message;?>
</div>
                <?php if (!empty($_smarty_tpl->getVariable('disscussion',null,true,false)->value->getDocument())){?>
                <div>
                <ul style="padding: 0; margin: 0;">
                    <?php  $_smarty_tpl->tpl_vars['document'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('disscussion')->value->getDocument(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
